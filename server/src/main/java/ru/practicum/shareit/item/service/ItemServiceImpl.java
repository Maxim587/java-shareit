...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public Collection<ItemExtendedDto> getUserItems(Long userId, Integer from, Integer size) {
        List<ItemExtendedDto> items = itemMapper.mapToItemExtendedDtoList(itemRepository.getItemsByOwner_Id(userId, PageRequest.of(from, size)));
